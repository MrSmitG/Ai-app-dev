...
- Android APKs: `npm run build:android` (needs Android SDK; GitHub Release workflow attaches `blackwhale.apk`, `nightweaver.apk`, `obsidian.apk`, `mako.apk`, `trench.apk`, `ironmantis.apk`)
