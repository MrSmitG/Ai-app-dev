...
| File | App |
|---|---|
| [blackwhale.apk](https://github.com/mrsmitg/ai-app-dev/releases/latest/download/blackwhale.apk) | Chat |
| [nightweaver.apk](https://github.com/mrsmitg/ai-app-dev/releases/latest/download/nightweaver.apk) | Agentic coding |
| [obsidian.apk](https://github.com/mrsmitg/ai-app-dev/releases/latest/download/obsidian.apk) | API keys |
